...
say_de +say_en say_es say_fr say_it say_nl say_zh shout siren skypiax +sndfile +sofia +speex
...
MODULES_RDEPEND="
	...
	freeswitch_modules_opal? ( >=net-libs/opal-3.6.0
				   >=dev-libs/ptlib-2.6.0 )
	...
	freeswitch_modules_skypiax? ( x11-base/xorg-server x11-apps/xhost net-im/skype )
"
