...
easyroute fax flite +g723_1 g729 h26x iax +ilbc java dingaling +local_stream +logfile +lua
managed opal openmrcp openzap perl pocketsphinx portaudio python radius_cdr
...
#		# libtool-2.2 patches
#		einfo "Applying libtool-2.2 patches..."
#		epatch "${FILESDIR}/${P}-libtool22.patch"
#		epatch "${FILESDIR}/openzap-618-libtool22.patch"
#
#		einfo "Re-bootstrapping, please wait..."
#		./bootstrap-update.sh
#	fi
}
...
pkg_preinst() {
	...
	#
	if use nosamples; then
		if has_version "net-misc/freeswitch" || has_version "net-misc/freeswitch"; then
